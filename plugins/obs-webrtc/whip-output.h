...
private:
	void ConfigureAudioTracks(std::string media_stream_id, std::string cname);
	...
	class TrackAndRTCP {
	public:
		TrackAndRTCP(std::shared_ptr<rtc::Track> track, std::shared_ptr<rtc::RtcpSrReporter> sr_reporter)
			: track(track),
